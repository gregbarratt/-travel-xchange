      ...
      <div className="mx-auto max-w-5xl rounded-lg border border-slate-200 bg-white p-5 shadow-2xl">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex gap-3">
            <span className="mt-1 rounded-lg bg-[var(--tx-accent-soft)] p-2 text-[var(--tx-accent)]">
              <Cookie className="size-5" aria-hidden="true" />
            </span>
            <div>
              <h2 className="text-base font-semibold text-[var(--tx-text)]">
                Cookie preferences
              </h2>
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
                ...
                <Link
                  className="font-semibold text-[var(--tx-accent)] underline-offset-4 hover:underline"
                  href="/legal/cookies"
                >
                  Cookie Policy
                </Link>
          ...
          <div className="flex flex-wrap gap-2 lg:justify-end">
            <button
              className="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-[var(--tx-text)] hover:bg-slate-50"
            ...
            <button
              className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-[var(--tx-text)] hover:bg-slate-50"
        ...
        {isManaging ? (
          <div className="mt-5 grid gap-3 border-t border-slate-200 pt-5 sm:grid-cols-3">
            <label className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
              <span className="font-semibold text-[var(--tx-text)]">Necessary</span>
            ...
            <label className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
              <span className="font-semibold text-[var(--tx-text)]">Analytics</span>
              <span className="mt-2 block leading-6 text-slate-600">
            ...
            <label className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
              <span className="font-semibold text-[var(--tx-text)]">Marketing</span>
              <span className="mt-2 block leading-6 text-slate-600">
            ...
            <div className="sm:col-span-3">
              <button
                className="rounded-lg bg-[var(--tx-text)] px-4 py-2 text-sm font-semibold text-white hover:bg-[#0b3d5f]"
                onClick={saveChoices}
                type="button"
              >
                Save choices
